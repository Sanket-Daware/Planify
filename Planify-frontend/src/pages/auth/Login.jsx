...
function Login() {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // You'll need to set up Google OAuth in your project
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Organizer & Team Member Login</p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h2 className="text-4xl font-bold text-white mb-4">
            Manage exhibitions with confidence
          </h2>
          <p className="text-lg text-indigo-100">
            Join thousands of organizers who trust PLANIFY to coordinate successful exhibitions worldwide.
          </p>
        </div>
      </div>
    </div>
